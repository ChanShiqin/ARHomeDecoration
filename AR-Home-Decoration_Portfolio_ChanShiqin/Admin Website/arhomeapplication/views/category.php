...
$totalCategories = ($data) ? count($data) : 0;
...
$categoriesToShow = ($data) ? array_slice($data, $startIndex, $itemsPerPage) : [];

// Retrieve products from Firebase
$productsData = $db->retrieve("product");
$productsData = json_decode($productsData, 1);
?>
    ...
    <div class="content">
        <div class="content-box">
            ...
            <div class="row greybar">
                ...
                <p class="categories"><b><?php echo"$totalCategories" ?> Categories</b></p>
                </div>
                ...
                <div class="perpage">
                    <div>
                    <p class="categories">
                        Total: &nbsp;<b> <?php echo"$totalCategories" ?></b>&nbsp; and showing 
            ...
            <div class="row" style="margin-top: 10px;">
                <table class="itemtable" style="padding: 0;">
                    <thead>
                        ...
                        <th scope="col" style="width: 20%;">Icons</th>
                        <th scope="col" style="width: 25%;">Name</th>
                        <th scope="col" style="width: 20%;">Total Products</th>
                        ...
                        <?php
                            if (!empty($categoriesToShow)) {
                                foreach ($categoriesToShow as $id => $category) {
                                    ...
                                    // Count the products that belong to the current category
                                    $productCount = 0;
                                    ...
                                    <tr>
                                        <td>
                                            <img src='data:image/png;base64,{$category['categoryIcon']}' class='icons'>
                                        </td>
                                      ...
                                      ";
                                        ...
                                        // <td class='status'>
                                    // // Use correct syntax for if-else inside echo
                                    ...
                                    echo "
                                        <td>
                                            <a href='editCategory.php?id=$id' style='text-decoration: none;'>
                                                <img src='../images/edit_icon.png' alt='Edit Icon' class='editicon'>
                                            </a>
                                            &nbsp;
                                            <a href='deleteCategory.php?id=$id' class='delete-link' onclick='return confirm(\"Are you sure you want to delete this category ?\");'>
