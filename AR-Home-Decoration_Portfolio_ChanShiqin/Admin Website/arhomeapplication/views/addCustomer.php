...
<body>
    ...
    <div class="content">
        <div class="content-box">
            ...
            <form action="../actions/action_addCustomer.php" method="post" enctype="multipart/form-data">
                <div class="row formframe">
                    <div class="col-12">
                        <p class="bigtitle"><b>Add New Customer</b></p>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        <p class="formtitledescription">Fill up the new customer personal details</p>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <div class="row" style="margin-bottom: 10px;">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                ...
                                <input type="file" name="customerProfilePic" class="form-control inputfield" accept="image/png, image/jpeg, image/gif, image/jpg" id="customerProfilePicUpload" required>
                            </div>
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                ...
                                <input type="text" name="customerName" class="form-control inputfield" placeholder="Enter Customer Full Name" required>
                            </div>
                            <!-- <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input type="text" name="customerPhoneNo" class="form-control inputfield" placeholder="Example: 0123456789" required
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input type="email" name="customerEmail" class="form-control inputfield" placeholder="Enter Customer Email" required>
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input type="password" name="customerPassword" id="customerPassword" class="form-control inputfield" placeholder="Enter Password" required
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input type="password" name="customerPasswordConfirm" id="customerPasswordConfirm" class="form-control inputfield" placeholder="Confirm Password" required>
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <input type="text" name="customerAddress" class="form-control inputfield" placeholder="Enter customer address" required >
                            </div>
                        </div>
                        ...
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                ...
                                <input type="text" name="customerPoscode" class="form-control inputfield" placeholder="Example: 12400" required
