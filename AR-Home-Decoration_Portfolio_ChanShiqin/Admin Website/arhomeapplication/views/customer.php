...
$customersToShow = ($data) ? array_slice($data, $startIndex, $itemsPerPage) : [];
?>
        ...
        <div class="content-box">
            <div class="row filterandaddbutton">
                <div class="col-xs-4 col-sm-6 col-md-9 col-lg-2">
                    <!-- <a href="addCustomer.php" class="btn add-button" id="add-button">+ Add New</a> -->
                </div>
            </div>        
            ...
            <div class="row greybar">
                ...
                <p class="categories"><b><?php echo"$totalCustomer" ?> Customers</b></p>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                    <div class="perpage">
                        <div>
                            <p class="categories">
                                Total: &nbsp;<b><?php echo"$totalCustomer" ?></b>&nbsp; and showing 
                ...
                <table class="itemtable" style="padding: 0;">
                    <thead>
                        <tr>
                            ...
                            <!-- <th scope="col" style="width: 15%;">PIC Phone</th> -->
                    ...
                    <tbody>
                        <?php
                        if (!empty($customersToShow)) {
                            foreach ($customersToShow as $id => $user) {
                                echo "
                                <tr>
                                    <td><b>{$user['email']}</b></td>
                                    <td>{$user['name']}</td>
                                    <td>{$user['phoneNo']}</td>
                                    <td>{$user['address']}, {$user['poscode']}, {$user['state']}</td>
                                    <td>
                                        <a href='editCustomer.php?id=$id' style='text-decoration: none;'>
                                            <img src='../images/edit_icon.png' alt='Edit Icon' class='editicon'>
                                        </a>
                                        &nbsp;
                                        <a href='deleteCustomer.php?id=$id' class='delete-link' onclick='return confirm(\"Are you sure you want to delete this customer account?\");'>
                            ...
                            echo "<tr><td colspan='7' style='text-align: center; vertical-align: middle;'>No customer account found.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
